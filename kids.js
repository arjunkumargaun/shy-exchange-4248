        ...
        let filtered = data.filter((item)=>{
             ...
             nikefilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="nike" && ele.category=="kids"){
                  return true
                }else{
                  return false
                }
            ...
            Adidasfilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="adidas" && ele.category=="kids"){
                  return true
                }else{
                  return false
                }
            ...
            Louisfilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="louis vuitton" && ele.category=="kids"){
                  return true
                }else{
                  return false
                }
            ...
            Cartierfilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="cartier" && ele.category=="kids"){
                  return true
                }else{
                  return false
                }
            ...
            Zarafilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="zara" && ele.category=="kids"){
                  return true
                }else{
                  return false
                }
