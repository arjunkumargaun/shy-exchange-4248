        ...
        let filtered = data.filter((item)=>{
             ...
             nikefilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="nike" && ele.category=="bags"){
                  return true
                }else{
                  return false
                }
            ...
            Adidasfilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="adidas" && ele.category=="bags"){
                  return true
                }else{
                  return false
                }
            ...
            Louisfilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="louis vuitton" && ele.category=="bags"){
                  return true
                }else{
                  return false
                }
            ...
            Cartierfilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="cartier" && ele.category=="bags"){
                  return true
                }else{
                  return false
                }
            ...
            Zarafilter.addEventListener("click",()=>{
              let filtered = data.filter((ele)=>{
                if(ele.brand=="zara" && ele.category=="bags"){
                  return true
                }else{
                  return false
                }
